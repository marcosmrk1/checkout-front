...
const ListProductPrice = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 ">
      <Card className="w-72 rounded-lg p-2 shadow-lg transition-all duration-300 hover:-translate-y-1 bg-card border-2 border-transparent hover:shadow-[0_0_20px_rgba(57,255,20,0.6),0_0_40px_rgba(57,255,20,0.3)]">
